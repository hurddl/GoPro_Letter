...
The launch agent listens for a disk mount. When it detects one, it runs the script. One small issue with launch agents is they can only run a script every 10 seconds. If you connect multiple cards one after another, it’ll be 10 seconds between each identification dialog popup.
